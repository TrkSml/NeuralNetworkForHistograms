...
class NeuralNetwork:
	...
	def build(self): 
		Network = Sequential() 
		Network.add(Dense(output_dim = 55, init='uniform', activation='relu', input_dim=111)) #first hidden layer
	...
	def fit_to_training(self):
		self.NN.fit(self.X_train, self.Y_train, batch_size = 10, nb_epoch = 100 )
